...
<head>
    <meta charset="utf-8">
    <title>Historique des transactions - {{ $chef->nom }} {{ $chef->prenoms }}</title>
    <style>
        body {
...
<body>
    ...
    <table class="info-table">
        <tr>
            <td class="label">Informations du chef chargeur</td>
            <td></td>
        </tr>
        <tr>
            <td>Chef Chargeur:</td>
    ...
    <div class="section">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" style="text-align: center;">Aucune fiche</td>
                    </tr>
                @endforelse
            </tbody>
