      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2"><img src="{{ asset('img/logo/logo.png') }}" alt="Logo" class="img-fluid"></span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('camions.index') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Without menu">Depenses & Fiche de Sortie</div>
                  </a>
                </li>
                <li class="menu-item">
        ...
        <!--<li class="menu-item">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('pesees.index') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Pesages">Liste des pesées</div>
                  </a>
                </li>
            <!--    <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('utilisateurs.index') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Basic">Tous les utilisateurs</div>
                  </a>
                </li>
                <li class="menu-item">
         ...
         <!--   <li class="menu-item">
            ...
            <!-- User interface -->
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('camions.activites') }}" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('particuliers.index') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Accordion">Groupe Particuliers</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="{{ route('particuliers.agents.index') }}" class="menu-link">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('financements.index') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Accordion">Financements</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="{{ route('avances_transporteur.index') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Accordion">Avances transporteurs</div>
                  </a>
                </li>
               <!--  <li class="menu-item">
                  <a href="ui-buttons.html" class="menu-link">
